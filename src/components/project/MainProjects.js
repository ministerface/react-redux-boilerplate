    ...
    return (
      <div>
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <Link to="/todos/new" activeClassName="none" className="btn btn-default btn-md waves-effect waves-light m-b-30 pull-right"> <i className="md md-add"></i> Новый проект </Link>
